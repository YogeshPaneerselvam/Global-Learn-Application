...
//This declares the ScreenRecordingClass which extends the ScreenRecorder class.
public class ScreenRecordingClass extends ScreenRecorder {
	...
	public ScreenRecordingClass(GraphicsConfiguration cfg, Rectangle captureArea, Format fileFormat, Format screenFormat,
	...
	public static void startRecord(String methodName) throws Exception {
		...
		screenRecorder = new ScreenRecordingClass(gc, captureSize, new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_AVI),
